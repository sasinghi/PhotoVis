...
public class FaceDetector {
    ...
    private static class Training {
        ...
        private static final FaceRecognizer  ALGO_FACTORY =
            com.googlecode.javacv.cpp.opencv_contrib.createLBPHFaceRecognizer(1, 8, 8, 8, THRESHOLD);
            //com.googlecode.javacv.cpp.opencv_contrib.createFisherFaceRecognizer(0, THRESHOLD);
            //com.googlecode.javacv.cpp.opencv_contrib.createEigenFaceRecognizer(0, THRESHOLD);
        ...
        void identify(BufferedImage image, PotentialFace face) {
            ...
            if (prediction[0] >= 0 && prediction[0] < names.length) {
                ...
                face.confidence = 100*(THRESHOLD - confidence[0])/THRESHOLD;
