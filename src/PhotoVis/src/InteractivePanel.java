...
public final class InteractivePanel extends JPanel {
    public InteractivePanel(BufferedImage img) {
    ...
    public static void createAndShowGUI() throws IOException {
        ...
        frame.getContentPane().add(new InteractivePanel(img));
        frame.pack();
